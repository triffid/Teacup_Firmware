...
void heater_print(uint16_t i) {
	sersendf_P(PSTR("P:%lq I:%lq D:%lq Ilim:%u crc:%u "), heaters_pid[i].p_factor*1000/PID_SCALE_P, heaters_pid[i].i_factor*1000/PID_SCALE_I, heaters_pid[i].d_factor*1000/PID_SCALE_D, heaters_pid[i].i_limit, crc_block(&heaters_pid[i].p_factor, 14));
}
#endif
